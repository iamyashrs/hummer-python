...
class Fingerprint:
    ...
    def _get_hash(self, audio_data):
        ...
        # (sound_info is the signal, NFFT is the length of the windowing segments and Fs is the sampling frequency)
        ...
        freq_batch_high = int(math.ceil((len(freqs) - freq_split_bin) / freq_bin_high))
